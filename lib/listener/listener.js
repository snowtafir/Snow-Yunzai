...
function getMsg(data, message_id) {
  return sendApi(data.ws, "get_msg", {
    message_id,
  });
}
...
function getForwardMsg(data, message_id) {
  return sendApi(data.ws, "get_forward_msg", {
    message_id,
  });
}
...
function getGroupInfo(data, group_id) {
  return sendApi(data.ws, "get_group_info", {
    group_id,
  })
}

function getGroupMemberInfo(data, user_id) {
  return sendApi(data.ws, "get_group_member_info", {
    group_id: data.group_id,
    user_id,
  })
}
...
function getGuildMemberInfo(data, user_id) {
  return sendApi(data.ws, "get_guild_member_profile", {
    guild_id: data.guild_id,
    user_id,
  })
}
...
async function connectBot(data) {
  ...
  Bot[data.self_id].clients = (await sendApi(data.ws, "get_online_clients")).clients,
  Bot[data.self_id].version = (await sendApi(data.ws, "get_version_info")).data,
