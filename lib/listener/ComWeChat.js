...
async function makeForwardMsg(data, send, msg) {
  const messages = []
  for (const i of msg)
  ...
  Bot[data.self_id] = {
    ...
    pickFriend: user_id => {
      ...
      return {
        ...
        recallMsg: () => false,
        makeForwardMsg: msg => makeForwardMsg(i, sendFriendMsg, msg),
        getInfo: () => getFriendInfo(i),
        getAvatarUrl: async () => (await getFriendInfo(i))["wx.avatar"],
      }
    },

    getFriendList: async () => (await data.sendApi("get_friend_list", {})).data,
    getFriendMap: () => Bot[data.self_id].fl,

    pickMember: (group_id, user_id) => {
      const i = { ...data, group_id, user_id }
      return {
        ...Bot[data.self_id].pickFriend(user_id),
        getInfo: () => getGroupMemberInfo(i),
        getAvatarUrl: async () => (await getGroupMemberInfo(i))["wx.avatar"],
      }
    },
    ...
    pickGroup: group_id => {
      ...
      return {
        ...
        recallMsg: () => false,
        makeForwardMsg: msg => makeForwardMsg(i, sendGroupMsg, msg),
        getInfo: () => getGroupInfo(i),
        getAvatarUrl: async () => (await getGroupInfo(i))["wx.avatar"],
    ...
    getGroupList: async () => (await data.sendApi("get_group_list", {})).data,
    getGroupMap: () => Bot[data.self_id].gl,
  }
